...
def execute_inventory_query(
    query: str, variables: DictAny | None = None, inventory_url_base: str = INVENTORY_URL_BASE
) -> InventoryOutput:
    """
    ...
    response = requests.post(
        inventory_url_base, json={"query": query, "variables": variables}, headers=INVENTORY_HEADERS
    )
